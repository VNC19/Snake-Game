...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    private String movingPositin = "right";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        surfaceView.getHolder().addCallback(this); //adding callback to surfaceView
        topBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (movingPositin.equals("bottom")) {
                    movingPositin = "top";
                }
            }
        });
        ...
        bottomBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (movingPositin.equals("top")) {
                    movingPositin = "bottom";
                }
            }
        });
    }
    ...
    private void moveSnake() {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                //check if game is over. Whether snake touch edges or snake itself
